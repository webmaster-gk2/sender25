  ...
  module MessageDB
    class Message
      ...
      def create_delivery(status, options = {})
        ...
        hold_expiry = status == "Held" ? Sender25::Config.sender25.default_maximum_hold_expiry_days.days.from_now.to_f : nil
      ...
      def rcpt_to_return_path?
        !!(rcpt_to =~ /@#{Regexp.escape(Sender25::Config.dns.custom_return_path_prefix)}\./)
      end
      ...
      #
      def parse_content
        parse_result = Sender25::MessageParser.new(self)
