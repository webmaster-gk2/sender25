  ...
  module MessageDB
    class ConnectionPool
      ...
      def establish_connection
        Mysql2::Client.new(
          host: Sender25::Config.message_db.host,
          username: Sender25::Config.message_db.username,
          password: Sender25::Config.message_db.password,
          port: Sender25::Config.message_db.port,
          encoding: Sender25::Config.message_db.encoding
        )
      end
